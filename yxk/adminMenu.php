...
{
?>
<form id="form0" name="form0" method="post" action="updateStudent.php">
...
<table width="80%" height="30" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <th align="center" width="4%"> 班级</th>
    <?php
	  for ($i=1; $i<=count($classNameArray); $i++)
      {
		  echo '<th align="center" width="'. 96/count($classNameArray) . '%">' . $classNameArray[$i] . '</th>';
      }
    ?>
  </tr>
  <tr>
